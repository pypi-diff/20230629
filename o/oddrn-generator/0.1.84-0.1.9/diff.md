# Comparing `tmp/oddrn_generator-0.1.84.tar.gz` & `tmp/oddrn-generator-0.1.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "oddrn_generator-0.1.84.tar", max compression
+gzip compressed data, was "oddrn-generator-0.1.9.tar", max compression
```

## Comparing `oddrn_generator-0.1.84.tar` & `oddrn-generator-0.1.9.tar`

### file list

```diff
@@ -1,12 +1,10 @@
--rw-r--r--   0        0        0    11356 2023-06-29 12:23:02.000000 oddrn_generator-0.1.84/LICENSE
--rw-r--r--   0        0        0     6337 2023-06-29 12:23:02.000000 oddrn_generator-0.1.84/README.md
--rw-r--r--   0        0        0     2592 2023-06-29 12:23:02.000000 oddrn_generator-0.1.84/oddrn_generator/__init__.py
--rw-r--r--   0        0        0      158 2023-06-29 12:23:02.000000 oddrn_generator-0.1.84/oddrn_generator/exceptions.py
--rw-r--r--   0        0        0    12365 2023-06-29 12:23:02.000000 oddrn_generator-0.1.84/oddrn_generator/generators.py
--rw-r--r--   0        0        0    23754 2023-06-29 12:23:02.000000 oddrn_generator-0.1.84/oddrn_generator/path_models.py
--rw-r--r--   0        0        0     3471 2023-06-29 12:23:02.000000 oddrn_generator-0.1.84/oddrn_generator/server_models.py
--rw-r--r--   0        0        0      287 2023-06-29 12:23:02.000000 oddrn_generator-0.1.84/oddrn_generator/utils/__init__.py
--rw-r--r--   0        0        0     7327 2023-06-29 12:23:02.000000 oddrn_generator-0.1.84/oddrn_generator/utils/external_generators.py
--rw-r--r--   0        0        0      734 2023-06-29 12:23:37.000000 oddrn_generator-0.1.84/pyproject.toml
--rw-r--r--   0        0        0     7363 1970-01-01 00:00:00.000000 oddrn_generator-0.1.84/setup.py
--rw-r--r--   0        0        0     7089 1970-01-01 00:00:00.000000 oddrn_generator-0.1.84/PKG-INFO
...
### Comparing `oddrn_generator-0.1.84/LICENSE` & `oddrn-generator-0.1.9/LICENSE`

 * *Files identical despite different names*

### Comparing `oddrn_generator-0.1.84/README.md` & `oddrn-generator-0.1.9/README.md`
...
### Comparing `oddrn_generator-0.1.84/pyproject.toml` & `oddrn-generator-0.1.9/pyproject.toml`
...
### Comparing `oddrn_generator-0.1.84/PKG-INFO` & `oddrn-generator-0.1.9/PKG-INFO`
