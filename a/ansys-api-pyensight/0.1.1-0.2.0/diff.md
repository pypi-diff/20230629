# Comparing `tmp/ansys-api-pyensight-0.1.1.tar.gz` & `tmp/ansys-api-pyensight-0.2.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "ansys-api-pyensight-0.1.1.tar", last modified: Thu Jun 29 14:17:55 2023, max compression
+gzip compressed data, was "ansys-api-pyensight-0.2.0.tar", last modified: Thu Jun 29 13:06:54 2023, max compression
```

## Comparing `ansys-api-pyensight-0.1.1.tar` & `ansys-api-pyensight-0.2.0.tar`

### file list

```diff
@@ -1,26 +1,95 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-29 14:17:55.451406 ansys-api-pyensight-0.1.1/
--rw-r--r--   0 runner    (1001) docker     (123)     1089 2023-06-29 14:17:39.000000 ansys-api-pyensight-0.1.1/LICENSE
--rw-r--r--   0 runner    (1001) docker     (123)     1993 2023-06-29 14:17:55.451406 ansys-api-pyensight-0.1.1/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)     1541 2023-06-29 14:17:39.000000 ansys-api-pyensight-0.1.1/README.md
--rw-r--r--   0 runner    (1001) docker     (123)      140 2023-06-29 14:17:39.000000 ansys-api-pyensight-0.1.1/pyproject.toml
--rw-r--r--   0 runner    (1001) docker     (123)       38 2023-06-29 14:17:55.451406 ansys-api-pyensight-0.1.1/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (123)     2079 2023-06-29 14:17:39.000000 ansys-api-pyensight-0.1.1/setup.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-29 14:17:55.443405 ansys-api-pyensight-0.1.1/src/
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-29 14:17:55.443405 ansys-api-pyensight-0.1.1/src/ansys/
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-29 14:17:55.443405 ansys-api-pyensight-0.1.1/src/ansys/api/
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-29 14:17:55.443405 ansys-api-pyensight-0.1.1/src/ansys/api/pyensight/
--rw-r--r--   0 runner    (1001) docker     (123)        5 2023-06-29 14:17:39.000000 ansys-api-pyensight-0.1.1/src/ansys/api/pyensight/VERSION
--rw-r--r--   0 runner    (1001) docker     (123)      231 2023-06-29 14:17:39.000000 ansys-api-pyensight-0.1.1/src/ansys/api/pyensight/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-06-29 14:17:39.000000 ansys-api-pyensight-0.1.1/src/ansys/api/pyensight/py.typed
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-29 14:17:55.447406 ansys-api-pyensight-0.1.1/src/ansys/api/pyensight/v0/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-06-29 14:17:39.000000 ansys-api-pyensight-0.1.1/src/ansys/api/pyensight/v0/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)     1620 2023-06-29 14:17:39.000000 ansys-api-pyensight-0.1.1/src/ansys/api/pyensight/v0/enshell.proto
--rw-r--r--   0 runner    (1001) docker     (123)    18258 2023-06-29 14:17:39.000000 ansys-api-pyensight-0.1.1/src/ansys/api/pyensight/v0/ensight.proto
--rw-r--r--   0 runner    (1001) docker     (123)  2446597 2023-06-29 14:17:39.000000 ansys-api-pyensight-0.1.1/src/ansys/api/pyensight/v0/ensight_api.xml
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-29 14:17:55.447406 ansys-api-pyensight-0.1.1/src/ansys_api_pyensight.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)     1993 2023-06-29 14:17:55.000000 ansys-api-pyensight-0.1.1/src/ansys_api_pyensight.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      590 2023-06-29 14:17:55.000000 ansys-api-pyensight-0.1.1/src/ansys_api_pyensight.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-06-29 14:17:55.000000 ansys-api-pyensight-0.1.1/src/ansys_api_pyensight.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)       91 2023-06-29 14:17:55.000000 ansys-api-pyensight-0.1.1/src/ansys_api_pyensight.egg-info/entry_points.txt
--rw-r--r--   0 runner    (1001) docker     (123)       28 2023-06-29 14:17:55.000000 ansys-api-pyensight-0.1.1/src/ansys_api_pyensight.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)        6 2023-06-29 14:17:55.000000 ansys-api-pyensight-0.1.1/src/ansys_api_pyensight.egg-info/top_level.txt
...
### Comparing `ansys-api-pyensight-0.1.1/LICENSE` & `ansys-api-pyensight-0.2.0/LICENSE`

 * *Files identical despite different names*

### Comparing `ansys-api-pyensight-0.1.1/PKG-INFO` & `ansys-api-pyensight-0.2.0/PKG-INFO`
...
-Version: 0.1.1
-Summary: Autogenerated python gRPC interface package for ansys-api-pyensight, built on 14:17:55 on 29 June 2023
+Version: 0.2.0
...
### Comparing `ansys-api-pyensight-0.1.1/README.md` & `ansys-api-pyensight-0.2.0/README.md`

 * *Files identical despite different names*

### Comparing `ansys-api-pyensight-0.1.1/src/ansys/api/pyensight/v0/enshell.proto` & `ansys-api-pyensight-0.2.0/src/ansys/api/pyensight/v0/enshell.proto`

 * *Files identical despite different names*

### Comparing `ansys-api-pyensight-0.1.1/src/ansys/api/pyensight/v0/ensight.proto` & `ansys-api-pyensight-0.2.0/src/ansys/api/pyensight/v0/ensight.proto`

 * *Files identical despite different names*

### Comparing `ansys-api-pyensight-0.1.1/src/ansys/api/pyensight/v0/ensight_api.xml` & `ansys-api-pyensight-0.2.0/src/ansys/api/pyensight/v0/ensight_api.xml`

 * *Files identical despite different names*

### Comparing `ansys-api-pyensight-0.1.1/src/ansys_api_pyensight.egg-info/PKG-INFO` & `ansys-api-pyensight-0.2.0/src/ansys_api_pyensight.egg-info/PKG-INFO`
