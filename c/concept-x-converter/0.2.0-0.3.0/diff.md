# Comparing `tmp/concept_x_converter-0.2.0-cp37-abi3-win_amd64.whl.zip` & `tmp/concept_x_converter-0.3.0-cp37-abi3-win_amd64.whl.zip`
...
## Comparing `concept_x_converter-0.2.0.dist-info/METADATA` & `concept_x_converter-0.3.0.dist-info/METADATA`
