# Comparing `tmp/mentord-1.1.5.tar.gz` & `tmp/mentord-1.1.6.tar.gz`
...
## Comparing `mentord-1.1.5.tar` & `mentord-1.1.6.tar`
...
### Comparing `mentord-1.1.5/PKG-INFO` & `mentord-1.1.6/PKG-INFO`
...
### Comparing `mentord-1.1.5/mentord/client.py` & `mentord-1.1.6/mentord/client.py`

 * *Files identical despite different names*

### Comparing `mentord-1.1.5/mentord/httpc.py` & `mentord-1.1.6/mentord/httpc.py`

 * *Files identical despite different names*

### Comparing `mentord-1.1.5/mentord.egg-info/PKG-INFO` & `mentord-1.1.6/mentord.egg-info/PKG-INFO`
...
### Comparing `mentord-1.1.5/setup.py` & `mentord-1.1.6/setup.py`
