# Comparing `tmp/nics-1.0.0rc2.tar.gz` & `tmp/nics-1.0.0rc3.tar.gz`
...
## Comparing `nics-1.0.0rc2.tar` & `nics-1.0.0rc3.tar`
...
### Comparing `nics-1.0.0rc2/LICENSE` & `nics-1.0.0rc3/LICENSE`

 * *Files identical despite different names*

### Comparing `nics-1.0.0rc2/PKG-INFO` & `nics-1.0.0rc3/PKG-INFO`
...
### Comparing `nics-1.0.0rc2/nics/__init__.py` & `nics-1.0.0rc3/nics/__init__.py`

 * *Files identical despite different names*

### Comparing `nics-1.0.0rc2/nics/_template/docs/assets/nics-logo500.jpg` & `nics-1.0.0rc3/nics/_template/docs/assets/nics-logo500.jpg`

 * *Files identical despite different names*

### Comparing `nics-1.0.0rc2/nics/_template/web/_sass/header.scss` & `nics-1.0.0rc3/nics/_template/web/_sass/header.scss`

 * *Files identical despite different names*

### Comparing `nics-1.0.0rc2/nics/_template/web/_sass/main.scss` & `nics-1.0.0rc3/nics/_template/web/_sass/main.scss`

 * *Files identical despite different names*

### Comparing `nics-1.0.0rc2/nics/_template/web/scripts/header.js` & `nics-1.0.0rc3/nics/_template/web/scripts/header.js`

 * *Files identical despite different names*

### Comparing `nics-1.0.0rc2/nics/compile/__init__.py` & `nics-1.0.0rc3/nics/compile/__init__.py`

 * *Files identical despite different names*

### Comparing `nics-1.0.0rc2/nics/compile/copying_template.py` & `nics-1.0.0rc3/nics/compile/copying_template.py`

 * *Files identical despite different names*

### Comparing `nics-1.0.0rc2/nics/compile/inspect.py` & `nics-1.0.0rc3/nics/compile/inspect.py`

 * *Files identical despite different names*

### Comparing `nics-1.0.0rc2/nics/compile/rewrite_the_header.py` & `nics-1.0.0rc3/nics/compile/rewrite_the_header.py`

 * *Files identical despite different names*

### Comparing `nics-1.0.0rc2/nics/constants.py` & `nics-1.0.0rc3/nics/constants.py`

 * *Files identical despite different names*

### Comparing `nics-1.0.0rc2/nics/wizard/__init__.py` & `nics-1.0.0rc3/nics/wizard/__init__.py`

 * *Files identical despite different names*

### Comparing `nics-1.0.0rc2/nics/wizard/settings_writer.py` & `nics-1.0.0rc3/nics/wizard/settings_writer.py`

 * *Files identical despite different names*

### Comparing `nics-1.0.0rc2/nics/wizard/workflows_writer.py` & `nics-1.0.0rc3/nics/wizard/workflows_writer.py`
...
### Comparing `nics-1.0.0rc2/nics.egg-info/PKG-INFO` & `nics-1.0.0rc3/nics.egg-info/PKG-INFO`
...
### Comparing `nics-1.0.0rc2/nics.egg-info/SOURCES.txt` & `nics-1.0.0rc3/nics.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `nics-1.0.0rc2/pyproject.toml` & `nics-1.0.0rc3/pyproject.toml`
