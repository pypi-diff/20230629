# Comparing `tmp/nics-1.0.0rc6.tar.gz` & `tmp/nics-1.0.0rc7.tar.gz`
...
## Comparing `nics-1.0.0rc6.tar` & `nics-1.0.0rc7.tar`
...
### Comparing `nics-1.0.0rc6/LICENSE` & `nics-1.0.0rc7/LICENSE`

 * *Files identical despite different names*

### Comparing `nics-1.0.0rc6/PKG-INFO` & `nics-1.0.0rc7/PKG-INFO`
...
### Comparing `nics-1.0.0rc6/nics/__init__.py` & `nics-1.0.0rc7/nics/__init__.py`

 * *Files identical despite different names*

### Comparing `nics-1.0.0rc6/nics/_template/docs/assets/nics-logo500.jpg` & `nics-1.0.0rc7/nics/_template/docs/assets/nics-logo500.jpg`

 * *Files identical despite different names*

### Comparing `nics-1.0.0rc6/nics/_template/web/_sass/header.scss` & `nics-1.0.0rc7/nics/_template/web/_sass/header.scss`

 * *Files identical despite different names*

### Comparing `nics-1.0.0rc6/nics/_template/web/_sass/main.scss` & `nics-1.0.0rc7/nics/_template/web/_sass/main.scss`

 * *Files identical despite different names*

### Comparing `nics-1.0.0rc6/nics/_template/web/scripts/header.js` & `nics-1.0.0rc7/nics/_template/web/scripts/header.js`

 * *Files identical despite different names*

### Comparing `nics-1.0.0rc6/nics/compile/__init__.py` & `nics-1.0.0rc7/nics/compile/__init__.py`

 * *Files identical despite different names*

### Comparing `nics-1.0.0rc6/nics/compile/inspect.py` & `nics-1.0.0rc7/nics/compile/inspect.py`

 * *Files identical despite different names*

### Comparing `nics-1.0.0rc6/nics/compile/rewrite_the_header.py` & `nics-1.0.0rc7/nics/compile/rewrite_the_header.py`

 * *Files identical despite different names*

### Comparing `nics-1.0.0rc6/nics/constants.py` & `nics-1.0.0rc7/nics/constants.py`

 * *Files identical despite different names*

### Comparing `nics-1.0.0rc6/nics/wizard/__init__.py` & `nics-1.0.0rc7/nics/wizard/__init__.py`

 * *Files identical despite different names*

### Comparing `nics-1.0.0rc6/nics/wizard/settings_writer.py` & `nics-1.0.0rc7/nics/wizard/settings_writer.py`

 * *Files identical despite different names*

### Comparing `nics-1.0.0rc6/nics/wizard/workflows_writer.py` & `nics-1.0.0rc7/nics/wizard/workflows_writer.py`

 * *Files identical despite different names*

### Comparing `nics-1.0.0rc6/nics.egg-info/PKG-INFO` & `nics-1.0.0rc7/nics.egg-info/PKG-INFO`
...
### Comparing `nics-1.0.0rc6/nics.egg-info/SOURCES.txt` & `nics-1.0.0rc7/nics.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `nics-1.0.0rc6/pyproject.toml` & `nics-1.0.0rc7/pyproject.toml`
