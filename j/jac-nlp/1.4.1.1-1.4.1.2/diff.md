# Comparing `tmp/jac_nlp-1.4.1.1.tar.gz` & `tmp/jac_nlp-1.4.1.2.tar.gz`
...
### Comparing `jac_nlp-1.4.1.1/README.md` & `jac_nlp-1.4.1.2/README.md`
...
### Comparing `jac_nlp-1.4.1.1/jac_nlp/action_configs/sentiment_action_config.py` & `jac_nlp-1.4.1.2/jac_nlp/action_configs/sentiment_action_config.py`
...
### Comparing `jac_nlp-1.4.1.1/jac_nlp/bi_enc/bi_enc.py` & `jac_nlp-1.4.1.2/jac_nlp/bi_enc/bi_enc.py`
...
### Comparing `jac_nlp-1.4.1.1/jac_nlp/cl_summer/cl_summer.py` & `jac_nlp-1.4.1.2/jac_nlp/cl_summer/cl_summer.py`

 * *Files identical despite different names*

### Comparing `jac_nlp-1.4.1.1/jac_nlp/cl_summer/tests/test_cl_summer.py` & `jac_nlp-1.4.1.2/jac_nlp/cl_summer/tests/test_cl_summer.py`

 * *Files identical despite different names*

### Comparing `jac_nlp-1.4.1.1/jac_nlp/config.py` & `jac_nlp-1.4.1.2/jac_nlp/config.py`

 * *Files identical despite different names*

### Comparing `jac_nlp-1.4.1.1/jac_nlp/dolly/dolly.py` & `jac_nlp-1.4.1.2/jac_nlp/dolly/dolly.py`

 * *Files identical despite different names*

### Comparing `jac_nlp-1.4.1.1/jac_nlp/ent_ext/ent_ext.py` & `jac_nlp-1.4.1.2/jac_nlp/ent_ext/ent_ext.py`

 * *Files identical despite different names*

### Comparing `jac_nlp-1.4.1.1/jac_nlp/ent_ext/entity_utils.py` & `jac_nlp-1.4.1.2/jac_nlp/ent_ext/entity_utils.py`

 * *Files identical despite different names*

### Comparing `jac_nlp-1.4.1.1/jac_nlp/ent_ext/tests/fixtures/ent_ext.jac` & `jac_nlp-1.4.1.2/jac_nlp/ent_ext/tests/fixtures/ent_ext.jac`

 * *Files identical despite different names*

### Comparing `jac_nlp-1.4.1.1/jac_nlp/ent_ext/tests/test_ent_ext.py` & `jac_nlp-1.4.1.2/jac_nlp/ent_ext/tests/test_ent_ext.py`

 * *Files identical despite different names*

### Comparing `jac_nlp-1.4.1.1/jac_nlp/gpt2/gpt2.py` & `jac_nlp-1.4.1.2/jac_nlp/gpt2/gpt2.py`

 * *Files identical despite different names*

### Comparing `jac_nlp-1.4.1.1/jac_nlp/gpt2/train.py` & `jac_nlp-1.4.1.2/jac_nlp/gpt2/train.py`

 * *Files identical despite different names*

### Comparing `jac_nlp-1.4.1.1/jac_nlp/gpt3/gpt3.py` & `jac_nlp-1.4.1.2/jac_nlp/gpt3/gpt3.py`

 * *Files identical despite different names*

### Comparing `jac_nlp-1.4.1.1/jac_nlp/paraphraser/paraphraser.py` & `jac_nlp-1.4.1.2/jac_nlp/paraphraser/paraphraser.py`

 * *Files identical despite different names*

### Comparing `jac_nlp-1.4.1.1/jac_nlp/paraphraser/tests/test_paraphraser.py` & `jac_nlp-1.4.1.2/jac_nlp/paraphraser/tests/test_paraphraser.py`

 * *Files identical despite different names*

### Comparing `jac_nlp-1.4.1.1/jac_nlp/sbert_sim/sbert_sim.py` & `jac_nlp-1.4.1.2/jac_nlp/sbert_sim/sbert_sim.py`

 * *Files identical despite different names*

### Comparing `jac_nlp-1.4.1.1/jac_nlp/sbert_sim/tests/fixtures/sbert_sim.jac` & `jac_nlp-1.4.1.2/jac_nlp/sbert_sim/tests/fixtures/sbert_sim.jac`

 * *Files identical despite different names*

### Comparing `jac_nlp-1.4.1.1/jac_nlp/sbert_sim/tests/test_sbert_sim.py` & `jac_nlp-1.4.1.2/jac_nlp/sbert_sim/tests/test_sbert_sim.py`

 * *Files identical despite different names*

### Comparing `jac_nlp-1.4.1.1/jac_nlp/sentiment/sentiment.py` & `jac_nlp-1.4.1.2/jac_nlp/sentiment/sentiment.py`

 * *Files identical despite different names*

### Comparing `jac_nlp-1.4.1.1/jac_nlp/t5_sum/t5_sum.py` & `jac_nlp-1.4.1.2/jac_nlp/t5_sum/t5_sum.py`

 * *Files identical despite different names*

### Comparing `jac_nlp-1.4.1.1/jac_nlp/t5_sum/tests/test_t5_sum.py` & `jac_nlp-1.4.1.2/jac_nlp/t5_sum/tests/test_t5_sum.py`

 * *Files identical despite different names*

### Comparing `jac_nlp-1.4.1.1/jac_nlp/text_seg/text_seg.py` & `jac_nlp-1.4.1.2/jac_nlp/text_seg/text_seg.py`

 * *Files identical despite different names*

### Comparing `jac_nlp-1.4.1.1/jac_nlp/tfm_ner/entity_utils.py` & `jac_nlp-1.4.1.2/jac_nlp/tfm_ner/entity_utils.py`

 * *Files identical despite different names*

### Comparing `jac_nlp-1.4.1.1/jac_nlp/tfm_ner/tests/fixtures/tfm_ner.jac` & `jac_nlp-1.4.1.2/jac_nlp/tfm_ner/tests/fixtures/tfm_ner.jac`

 * *Files identical despite different names*

### Comparing `jac_nlp-1.4.1.1/jac_nlp/tfm_ner/tests/test_tfm_ner.py` & `jac_nlp-1.4.1.2/jac_nlp/tfm_ner/tests/test_tfm_ner.py`

 * *Files identical despite different names*

### Comparing `jac_nlp-1.4.1.1/jac_nlp/tfm_ner/tfm_ner.py` & `jac_nlp-1.4.1.2/jac_nlp/tfm_ner/tfm_ner.py`

 * *Files identical despite different names*

### Comparing `jac_nlp-1.4.1.1/jac_nlp/tfm_ner/train.py` & `jac_nlp-1.4.1.2/jac_nlp/tfm_ner/train.py`

 * *Files identical despite different names*

### Comparing `jac_nlp-1.4.1.1/jac_nlp/tfm_ner/utils/data_tokens.py` & `jac_nlp-1.4.1.2/jac_nlp/tfm_ner/utils/data_tokens.py`

 * *Files identical despite different names*

### Comparing `jac_nlp-1.4.1.1/jac_nlp/topic_ext/action_utils.py` & `jac_nlp-1.4.1.2/jac_nlp/topic_ext/action_utils.py`

 * *Files identical despite different names*

### Comparing `jac_nlp-1.4.1.1/jac_nlp/topic_ext/topic_ext.py` & `jac_nlp-1.4.1.2/jac_nlp/topic_ext/topic_ext.py`

 * *Files identical despite different names*

### Comparing `jac_nlp-1.4.1.1/jac_nlp/use_enc/tests/fixtures/use_enc.jac` & `jac_nlp-1.4.1.2/jac_nlp/use_enc/tests/fixtures/use_enc.jac`

 * *Files identical despite different names*

### Comparing `jac_nlp-1.4.1.1/jac_nlp/use_enc/tests/test_use_enc.py` & `jac_nlp-1.4.1.2/jac_nlp/use_enc/tests/test_use_enc.py`

 * *Files identical despite different names*

### Comparing `jac_nlp-1.4.1.1/jac_nlp/use_enc/use_enc.py` & `jac_nlp-1.4.1.2/jac_nlp/use_enc/use_enc.py`

 * *Files identical despite different names*

### Comparing `jac_nlp-1.4.1.1/jac_nlp/use_qa/tests/fixtures/use_qa.jac` & `jac_nlp-1.4.1.2/jac_nlp/use_qa/tests/fixtures/use_qa.jac`

 * *Files identical despite different names*

### Comparing `jac_nlp-1.4.1.1/jac_nlp/use_qa/tests/test_use_qa.py` & `jac_nlp-1.4.1.2/jac_nlp/use_qa/tests/test_use_qa.py`

 * *Files identical despite different names*

### Comparing `jac_nlp-1.4.1.1/jac_nlp/use_qa/use_qa.py` & `jac_nlp-1.4.1.2/jac_nlp/use_qa/use_qa.py`

 * *Files identical despite different names*

### Comparing `jac_nlp-1.4.1.1/jac_nlp/zs_classifier/zs_classifier.py` & `jac_nlp-1.4.1.2/jac_nlp/zs_classifier/zs_classifier.py`

 * *Files identical despite different names*

### Comparing `jac_nlp-1.4.1.1/jac_nlp.egg-info/PKG-INFO` & `jac_nlp-1.4.1.2/jac_nlp.egg-info/PKG-INFO`
...
### Comparing `jac_nlp-1.4.1.1/jac_nlp.egg-info/SOURCES.txt` & `jac_nlp-1.4.1.2/jac_nlp.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `jac_nlp-1.4.1.1/jac_nlp.egg-info/requires.txt` & `jac_nlp-1.4.1.2/jac_nlp.egg-info/requires.txt`
...
### Comparing `jac_nlp-1.4.1.1/setup.py` & `jac_nlp-1.4.1.2/setup.py`
