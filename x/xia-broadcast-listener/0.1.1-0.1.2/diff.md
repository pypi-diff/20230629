# Comparing `tmp/xia_broadcast_listener-0.1.1-cp39-none-win_amd64.whl.zip` & `tmp/xia_broadcast_listener-0.1.2-cp39-none-macosx_11_0_x86_64.whl.zip`
...
+Zip file size: 3385 bytes, number of entries: 7
+-rw-r--r--  2.0 unx      124 b- defN 23-Jun-29 20:37 xia_broadcast_listener/__init__.py
+-rw-r--r--  2.0 unx     3831 b- defN 23-Jun-29 20:37 xia_broadcast_listener/listener.py
+-rw-r--r--  2.0 unx      151 b- defN 23-Jun-29 20:37 xia_broadcast_listener-0.1.2.dist-info/LICENSE.txt
+-rw-r--r--  2.0 unx      712 b- defN 23-Jun-29 20:37 xia_broadcast_listener-0.1.2.dist-info/METADATA
+-rw-r--r--  2.0 unx      108 b- defN 23-Jun-29 20:37 xia_broadcast_listener-0.1.2.dist-info/WHEEL
+-rw-r--r--  2.0 unx       23 b- defN 23-Jun-29 20:37 xia_broadcast_listener-0.1.2.dist-info/top_level.txt
+?rw-rw-r--  2.0 unx      645 b- defN 23-Jun-29 20:37 xia_broadcast_listener-0.1.2.dist-info/RECORD
+7 files, 5594 bytes uncompressed, 2219 bytes compressed:  60.3%
```
