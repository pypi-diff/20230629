# Comparing `tmp/resize_icon-0.1.0.tar.gz` & `tmp/resize_icon-0.1.1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "resize_icon-0.1.0.tar", max compression
+gzip compressed data, was "resize_icon-0.1.1.tar", max compression
```

## Comparing `resize_icon-0.1.0.tar` & `resize_icon-0.1.1.tar`

### file list

```diff
@@ -1,4 +1,6 @@
--rw-r--r--   0        0        0        0 2023-06-29 10:19:52.627269 resize_icon-0.1.0/README.md
--rw-r--r--   0        0        0      343 2023-06-29 10:21:22.073593 resize_icon-0.1.0/pyproject.toml
--rw-r--r--   0        0        0        0 2023-06-29 10:19:52.627228 resize_icon-0.1.0/resize_icon/__init__.py
--rw-r--r--   0        0        0      367 1970-01-01 00:00:00.000000 resize_icon-0.1.0/PKG-INFO
