# Comparing `tmp/pwl_writer-1.1.1.tar.gz` & `tmp/pwl_writer-1.1.2.tar.gz`
...
## Comparing `pwl_writer-1.1.1.tar` & `pwl_writer-1.1.2.tar`
...
### Comparing `pwl_writer-1.1.1/.gitignore` & `pwl_writer-1.1.2/.gitignore`

 * *Files identical despite different names*

### Comparing `pwl_writer-1.1.1/LICENSE` & `pwl_writer-1.1.2/LICENSE`

 * *Files identical despite different names*

### Comparing `pwl_writer-1.1.1/README.md` & `pwl_writer-1.1.2/README.md`

 * *Files identical despite different names*

### Comparing `pwl_writer-1.1.1/docs/pwl_writer.html` & `pwl_writer-1.1.2/docs/pwl_writer.html`
...
+</ul>
+<h3>Summary</h3>
+<p>Property defining if object should be plotted by the PWL plotter method.</p>
+<h3>Raises</h3>
+<ul>
+<li><code>TypeError</code> : Raised if the assigned value is not a boolean.</li>
+</ul>
+<h3>See Also</h3>
+<ul>
...
-same time axis.
+Class method that takes all instances of the PWL class with plot enable flag
+set to True and plots them on the same time axis.
 **** Arguments ****
...
### Comparing `pwl_writer-1.1.1/docs/pycco.css` & `pwl_writer-1.1.2/docs/pycco.css`

 * *Files identical despite different names*

### Comparing `pwl_writer-1.1.1/pwl_writer/pwl_writer.py` & `pwl_writer-1.1.2/pwl_writer/pwl_writer.py`
...
### Comparing `pwl_writer-1.1.1/pyproject.toml` & `pwl_writer-1.1.2/pyproject.toml`

 * *Files identical despite different names*

### Comparing `pwl_writer-1.1.1/PKG-INFO` & `pwl_writer-1.1.2/PKG-INFO`
